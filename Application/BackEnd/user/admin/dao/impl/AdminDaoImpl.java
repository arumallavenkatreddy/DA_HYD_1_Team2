...
public class AdminDaoImpl implements AdminDao {
	...
	Map<String, Integer> lendingPeriods = new HashMap();
	...
	public int addAsset(Asset asset) {
		...
		try {
			...
			pst.setString(5, asset.getDateAdded().toString());
			pst.setBoolean(6, asset.getIsAvailable());
	...
	public List<BorrowedAsset> overDueAssetsByDate() throws AssetsNotFoundException {
		...
		List<BorrowedAsset> overDueAssetsList = new ArrayList();
	...
	// Method is used to return over due assets by name
	@Override
