...
public class EmployeeDaoImpl implements EmployeeDao {
	...
	public String registerEmployee(User user)
			throws EmployeeAlreadyExistException, EmailFormatException, PasswordFormatException ,PhoneNumberFormatException,UserNameAlreadyExistException{
	...
	public String borrowAsset(String assetType, User user) throws OverDueAssetFoundException {
		...
		if (flag == false) {
			...
			for (Asset asset : availableAssetsList) {
				asset.getAssetType().equals(assetType);
				status = true;
